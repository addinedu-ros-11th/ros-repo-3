"""
malle_service - Main API server + WebSocket hub.
Port: 8000
"""
...
async def lifespan(app: FastAPI):
    # Startup: create tables if they don't exist (dev only; production uses migrations)
...
app.include_router(pickup.router, prefix="/api/v1", tags=["pickup"])
app.include_router(lockbox.router, prefix="/api/v1", tags=["lockbox"])
